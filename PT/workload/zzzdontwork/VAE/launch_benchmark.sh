...
function prepare_workload {
    ...
    if [ ! -e CelebA ];then
        ln -sf  /home2/pytorch-broad-models/CelebA/ .
    fi
}
...
function main {
    ...
    do
        # pre run
        python test.py -b 1 --no-cuda --arch VAE --warmup-iterations 1 --num-iterations 2 ./CelebA \
...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            python test.py --no-cuda --arch VAE ./CelebA \
