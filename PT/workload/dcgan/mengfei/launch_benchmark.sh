...
function main {
    ...
    patch -p1 < ${workload_dir}/enable_jit.patch || true
    ...
    do
        # pre run
        python main.py --inference --dataset fake --batchSize 1 \
                --channels_last ${channels_last} --precision ${precision} --config_file ${workload_dir}/conf.yaml
        #
...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            python main.py --inference --dataset fake \
