...
function prepare_workload {
    ...
    patch -p1 < ${workload_dir}/YOLOV2.patch || true
    ...
    if [ ! -e YOLOV2 ];then
        ln -sf /home2/pytorch-broad-models/YOLOV2/ .
    fi
}
...
function main {
    ...
    do
        # pre run
        python ./eval_voc.py --arch Yolo2 --trained_model ./YOLOV2/yolo_v2_250epoch_77.1_78.1.pth \
            --voc_root ./YOLOV2/VOCdevkit/ --max_iters 2  --warmup 1 \
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            python ./eval_voc.py --arch Yolo2 \
                --trained_model ./YOLOV2/yolo_v2_250epoch_77.1_78.1.pth \
                --voc_root ./YOLOV2/VOCdevkit/ \
