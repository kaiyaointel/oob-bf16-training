...
function main {
    ...
    if [ ! -e dataset ];then
        ln -sf /home2/pytorch-broad-models/ResNext3d/dataset/ .
    fi
    ...
    do
        # pre run
        python test/models_resnext3d_test.py --arch ResNext3D -w 1 -i 2 -b 1 \
...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            python test/models_resnext3d_test.py --arch ResNext3D \
