...
function main {
    ...
    cd pytorch/
    if [ ! -e model ];then
        ln -sf /home2/pytorch-broad-models/transfo-xl/model/ .
    fi
    if [ ! -e data ];then
        mkdir data
        cd data/
    ...
    do
        ...
        python eval.py --data ./data/wikitext-103/ --dataset wt103 --tgt_len 64 --mem_len 640 --clamp_len 400 --batch_size 1 \
            --same_length --split test --work_dir ./model/ --arch TransformerXL --eval_warmup 1 --eval_iters 2 \
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            python eval.py --data ./data/wikitext-103/ --dataset wt103 --tgt_len 64 --mem_len 640 --clamp_len 400 \
                --same_length --split test --work_dir ./model/ --arch TransformerXL \
