...
function main {
    ...
    cd codes/
    if [ ! -e MGANet_model_AI37.pth ];then
        ln -sf /home2/pytorch-broad-models/MGANet-DCC2020/model/MGANet_model_AI37.pth ./
    fi
    ...
    do
        # pre run
        python MGANet_test_AI37.py --net_G ./MGANet_model_AI37.pth --arch MGANet --batch_size 1 \
...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            python MGANet_test_AI37.py --net_G ./MGANet_model_AI37.pth --arch MGANet \
