...
function main {
    ...
    do
        # cache weight
        python examples/imagenet_eval.py -e --performance --pretrained None --dummy -j 1 -w 1 -i 2 \
...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            python examples/imagenet_eval.py -e --performance --pretrained None --dummy -j 1 \
