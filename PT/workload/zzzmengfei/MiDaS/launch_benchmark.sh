...
function main {
    ...
    if [ ! -e model-small-70d6b9c8.pt ];then
        ln -sf /home2/pytorch-broad-models/midasnet/models/model-small-70d6b9c8.pt .
    ...
    do
        # pre run
        python run.py --model_weights ./model-small-70d6b9c8.pt --model_type small --arch midasnet \
