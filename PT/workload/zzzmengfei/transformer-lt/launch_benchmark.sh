...
function main {
    ...
    if [ ! -e data-bin ];then
        ln -sf /home2/pytorch-broad-models/Transformer-LT/data-bin/ .
    fi
    ...
    do
        # pre run
        fairseq-generate ./data-bin/iwslt14.tokenized.de-en --path ./data-bin/checkpoint_best.pt --beam 5 \
...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} timeout 7200 \
            fairseq-generate ./data-bin/iwslt14.tokenized.de-en --path ./data-bin/checkpoint_best.pt \
