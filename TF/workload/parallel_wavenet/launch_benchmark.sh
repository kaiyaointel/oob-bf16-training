...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} \
                timeout 7200 python3 eval_parallel_wavenet.py \
		--ckpt_dir /home2/tensorflow-broad-product/oob_tf_models/dpg/Parallel_WaveNet \
		--source_path tests/test_data/ \
		--save_path tests/pred_data \
