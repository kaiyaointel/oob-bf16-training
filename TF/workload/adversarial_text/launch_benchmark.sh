...
function init_params {
    ...
    model=${model_name}
    TRAIN_DIR="/home2/tensorflow-broad-product/mlp/adversarial_text/imdb_pretrain"
    IMDB_DATA_DIR="/home2/tensorflow-broad-product/mlp/adversarial_text/IMBD"
...
function generate_core {
    ...
    do
        ...
        printf "numactl --localalloc --physcpubind ${cpu_array[i]} \
                timeout 3600 python evaluate.py \
