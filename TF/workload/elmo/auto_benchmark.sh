...
pip install smart_open>1.8.1

git clone https://github.com/ltgoslo/simple_elmo.git
cd simple_elmo && git reset --hard c97cbf169e1fc99493d5410be359eed7e73c9424

ln -s ${tf_pretrain_path}/dpg/elmo/data/ data
ln -s ${tf_pretrain_path}/dpg/elmo/model/ model

git apply ${PATCH_DIR}/0001-mlpc_elmo.patch
