...
mkdir wd
cd wd
cp -r ${tf_pretrain_path}/mlp/WD/test.py test.py
cp -r ${tf_pretrain_path}/mlp/WD/test.sh test.sh
chmod 777 test.sh
ln -s ${tf_pretrain_path}/mlp/WD/census_data census_data
ln -s ${tf_pretrain_path}/mlp/WD/wide_deep_saved_models wide_deep_saved_models
